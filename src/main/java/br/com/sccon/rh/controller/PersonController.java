...
public class PersonController {
    ...
    @PutMapping("/{id}")
    public Person updatePut(@PathVariable("id") Integer id, @Valid @RequestBody Person person) {
    ...
    @PatchMapping("/{id}")
    public Person updatePatch(@PathVariable("id") Integer id, @RequestBody Person person) {
        return personService.update(id, person);
    }
